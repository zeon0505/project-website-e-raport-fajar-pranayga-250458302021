        ...
        <div class="sidebar-menu">
            <ul class="menu">
                @if (auth()->user()->role == 'admin')
                    ...
                    <li class="sidebar-item {{ request()->routeIs('admin.list-laporan') ? 'active' : '' }}">
                        <a href="{{ route('admin.list-laporan') }}" class='sidebar-link'>
                            <i class="bi bi-file-text-fill"></i>
                            <span>List Laporan</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('admin.list-warga') ? 'active' : '' }}">
                        <a href="{{ route('admin.list-warga') }}" class='sidebar-link'>
                            <i class="bi bi-people-fill"></i>
                            <span>List Warga</span>
                        </a>
                    </li>
                ...
                @else
                    ...
                    <li class="sidebar-item {{ request()->routeIs('warga.dashboard') ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->routeIs('warga.laporan') ? 'active' : '' }}">
                        <a href="{{ route('warga.laporan') }}" class='sidebar-link'>
                            <i class="bi bi-file-text-fill"></i>
                            <span>Laporan</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('warga.profile') ? 'active' : '' }}">
                        <a href="{{ route('warga.profile') }}" class='sidebar-link'>
                            <i class="bi bi-person-fill"></i>
                            <span>Profile</span>
                        </a>
                    </li>
